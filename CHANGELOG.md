...
- 艦娘の座り・ごろ寝・怨念切れ等で高さがずれる移植不備を修正しました。
  ...
  記録: `docs/changes/model_floating_legacy_restoration_2026-09-12.md`。
...
- 深海棲艦の乗り物が解除後も残って積み重なる問題を修正しました。解除時に乗客を降ろして
  ...
  判断と検証記録: `docs/changes/mount_single_instance_2026-09-09.md`。
...
- 指揮棒の陣形GUI・地点護衛・実体護衛・チーム管理・モード切替に使うキーを、
  ...
  既存の優先順に従います。設計理由と検証範囲は `docs/changes/pointer_keybind_config_2026-09-09.md` を参照してください。
