 ...
 */
public class ModelAirplaneT extends ShipModelBaseAdv<Entity> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(Reference.MOD_ID, "airplane_t"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bodyMain.addOrReplaceChild("Wing02",
                ...
                PartPose.offsetAndRotation(-2.0F, -0.4F, -2.5F, 0.0F, 0.0F, 0.0698F));
        ...
        bodyMain.addOrReplaceChild("Prop02",
                CubeListBuilder.create().texOffs(1, 25)
                        .addBox(-0.5F, -0.5F, 0.0F, 1, 1, 2),
                PartPose.offset(0.0F, -1.0F, -7.1F));
        ...
        bodyMain.addOrReplaceChild("Tank",
                CubeListBuilder.create().texOffs(32, 7)
                        .addBox(-1.0F, 0.0F, 0.0F, 2, 2, 14),
                PartPose.offsetAndRotation(0.0F, 1.5F, -5.5F, 0.0349F, 0.0F, 0.0F));
