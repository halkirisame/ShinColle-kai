...
public class ModelBBHaruna extends ShipModelBaseAdv<Entity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(Reference.MOD_ID, "bb_haruna"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        hair.addOrReplaceChild("HairCBase",
        ...
        hair.addOrReplaceChild("HairCBaseB",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F),
                PartPose.offsetAndRotation(-6.0F, 1.0F, -1.6F, 0.0F, 0.0F, 0.3141592653589793F));
        ...
        PartDefinition hair01 = hairMain.addOrReplaceChild("Hair01",
                CubeListBuilder.create().texOffs(153, 106)
        ...
        hair01.addOrReplaceChild("Hair02",
                CubeListBuilder.create().texOffs(202, 107)
    ...
    public void applyDeadPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        switch (ent.getScaleLevel()) {
            case 3:
                ...
                this.translateLegacyPose(0F, 1.5F, 0F);

                break;
            case 2:
                this.translateLegacyPose(0F, 1.33F, 0F);
            ...
            case 1:
                ...
                break;
            default:
                this.translateLegacyPose(0F, 0.72F, 0F);
        ...
        this.setLegacyPartOffsetZ(this.ArmLeft02, -0.33F);
        ...
        this.setLegacyPartOffsetZ(this.ArmRight02, -0.33F);
        // leg
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        if (ent.getIsSitting() || ent.getIsRiding()) {
            ...
            if (ent.getTickExisted() % 512 > 256) {
                ...
                switch (ent.getScaleLevel()) {
                    case 3:
                        this.translateLegacyPose(0F, 0.79F, 0F);
                        break;
                    case 2:
                        this.translateLegacyPose(0F, 0.7F, 0F);
                        break;
                    case 1:
