...
public class ModelCarrierKaga extends ShipModelBaseAdv<Entity> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(Reference.MOD_ID, "cv_kaga"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition equipABody01 = equipABelt01.addOrReplaceChild("EquipABody01",
                ...
                PartPose.offsetAndRotation(-12.5F, -1.5F, 0.0F, 0.0F, 0.0F, -0.7853981633974483F));
        ...
        equipABody05c.addOrReplaceChild("EquipABelt02",
                CubeListBuilder.create().texOffs(0, 27)
                        .addBox(0.0F, 0.0F, -0.5F, 18.0F, 0.0F, 1.0F),
        ...
        PartDefinition equipD01 = armLeft01.addOrReplaceChild("EquipD01",
                CubeListBuilder.create().texOffs(150, 13)
                        .addBox(-3.0F, 0.0F, -3.5F, 8.0F, 1.0F, 7.0F),
                PartPose.offset(0.3F, 2.0F, 0.0F));
        ...
        PartDefinition equipD02 = equipD01.addOrReplaceChild("EquipD02",
                ...
                PartPose.offsetAndRotation(5.6F, 3.0F, 0.0F, -0.05235987755982988F, 1.6755160819145563F,
                        3.141592653589793F));
        ...
        PartDefinition hair00 = hairMain.addOrReplaceChild("Hair00",
                CubeListBuilder.create().texOffs(64, 40)
                        .addBox(0.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F),
                PartPose.offsetAndRotation(5.0F, 4.0F, 5.5F, 0.05235987755982988F,
                        -0.17453292519943295F, -0.08726646259971647F));

        PartDefinition hair01 = hair00.addOrReplaceChild("Hair01",
                CubeListBuilder.create().texOffs(60, 38)
                        .addBox(0.0F, -3.0F, -3.0F, 6.0F, 9.0F, 6.0F),
                PartPose.offset(3.0F, -1.0F, 0.0F));

        hair01.addOrReplaceChild("Hair02",
                CubeListBuilder.create().mirror().texOffs(63, 39)
                        .addBox(0.0F, 0.0F, -2.5F, 5.0F, 8.0F, 5.0F),
                PartPose.offsetAndRotation(0.6F, 4.2F, 0.0F, -0.05235987755982988F, 0.0F,
        ...
        hair.addOrReplaceChild("HairU01",
                CubeListBuilder.create().texOffs(82, 0)
                        .addBox(-8.5F, 0.0F, 0.0F, 17.0F, 12.0F, 6.0F),
        ...
        PartDefinition armRight01 = bodyMain.addOrReplaceChild("ArmRight01",
                ...
                PartPose.offsetAndRotation(-7.8F, -8.7F, -0.7F, 0.05235987755982988F, 0.0F,
                        0.3141592653589793F));
        ...
        PartDefinition clothHR01 = armRight01.addOrReplaceChild("ClothHR01",
                CubeListBuilder.create().texOffs(43, 1)
                        .addBox(-3.5F, 0.0F, -3.0F, 6.0F, 5.0F, 6.0F),
                PartPose.offset(0.0F, -1.5F, 0.0F));

        PartDefinition clothHR02 = clothHR01.addOrReplaceChild("ClothHR02",
                CubeListBuilder.create().texOffs(42, 1)
                        .addBox(-4.0F, 0.0F, -3.0F, 7.0F, 5.0F, 6.0F),
                PartPose.offset(0.0F, 4.5F, 0.0F));

        clothHR02.addOrReplaceChild("ClothHR03",
                CubeListBuilder.create().texOffs(40, 0)
        ...
        PartDefinition tail01 = butt.addOrReplaceChild("Tail01",
                ...
                PartPose.offsetAndRotation(0.0F, 7.5F, 1.0F, -0.6981317007977318F, 0.0F, 0.0F));
