...
public class ModelDestroyerInazuma extends ShipModelBaseAdv<Entity> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(Reference.MOD_ID, "destroyer_inazuma"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition hairMain = head.addOrReplaceChild("HairMain",
                ...
                PartPose.offset(0.0F, -12.5F, -2.8F));

        PartDefinition hair01 = hairMain.addOrReplaceChild("Hair01",
                CubeListBuilder.create().texOffs(51, 108)
                        .addBox(-3.5F, 0.0F, 0.0F, 7.0F, 4.0F, 6.0F),
                PartPose.offsetAndRotation(0.0F, 8.7F, 6.2F, 0.136659280431156F, 0.0F, 0.0F));

        hair01.addOrReplaceChild("Hair02",
                CubeListBuilder.create().texOffs(62, 27)
                        .addBox(-3.5F, -9.0F, 0.0F, 7.0F, 14.0F, 4.0F),
                PartPose.offsetAndRotation(0.0F, -5.4F, 3.5F, -0.3141592653589793F, 0.0F, 0.0F));
        ...
        PartDefinition legRight01 = butt.addOrReplaceChild("LegRight01",
                ...
                PartPose.offsetAndRotation(-4.4F, 5.5F, 3.2F, -0.06981317007977318F, 0.0F,
        ...
        PartDefinition legLeft01 = butt.addOrReplaceChild("LegLeft01",
                CubeListBuilder.create().mirror().texOffs(0, 59)
                        .addBox(-3.0F, 0.0F, -3.0F, 6.0F, 12.0F, 6.0F),
                PartPose.offsetAndRotation(4.4F, 5.5F, 3.2F, -0.12217304763960307F, 0.0F,
                        0.10471975511965977F));
        ...
        PartDefinition armLeft01 = bodyMain.addOrReplaceChild("ArmLeft01",
                ...
                PartPose.offsetAndRotation(7.3F, -9.4F, -0.7F, -0.2792526803190927F, 0.0F,
                        0.2792526803190927F));
    ...
    public void applyDeadPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        this.translateLegacyPose(0F, 0.51F + 0.24F * ent.getScaleLevel(), 0F);
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        net.minecraft.world.entity.Entity mount = ((net.minecraft.world.entity.LivingEntity) ent).getVehicle();
        if (ent.getRidingState() > 0) {
            if (ent.getRidingState() > 1) {
                ...
                if (ent.getIsSitting() && ent.getRidingState() != 3) {
                    // Body
                    // [PORT] Restored from 1.10.2 GlStateManager.translate
                    this.translateLegacyPose(0F, 0.275F, 0F);
            ...
            if (ent.getIsSitting() || ent.getIsRiding()) { // 騎乘動作
                if (ent.getStateEmotion(ID.S.Emotion) == ID.Emotion.BORED) {
                    // head
                    // [PORT] Restored from 1.10.2 GlStateManager.translate
                    this.translateLegacyPose(0F, 0.375F, 0F);
                    ...
                    this.setLegacyPartOffsetX(this.LegLeft02, 0.32F);
                    this.setLegacyPartOffsetY(this.LegLeft02, 0.05F);
                    this.setLegacyPartOffsetZ(this.LegLeft02, 0.35F);
                    this.LegRight01.zRot = 0.14F;
                    this.LegRight02.xRot = 1.2217F;
                    this.LegRight02.yRot = -1.2217F;
                    this.LegRight02.zRot = 1.0472F;
                    this.setLegacyPartOffsetX(this.LegRight02, -0.32F);
                    this.setLegacyPartOffsetY(this.LegRight02, 0.05F);
                    this.setLegacyPartOffsetZ(this.LegRight02, 0.35F);
                } else {
                    // Body
                    this.translateLegacyPose(0F, 0.275F, 0F);
                    this.Head.xRot -= 0.1F;
        ...
        if (ent.getAttackTick() > 30) {
            ...
            this.Butt.xRot = -0.3F;
            this.setLegacyPartOffsetY(this.Butt, -0.15F);
            // arm
            this.ArmLeft01.xRot = -0.8F;
