...
public class ModelSSNH extends ShipModelBaseAdv<Entity> {
    ...
    public void applyDeadPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        this.setLegacyPartOffsetY(this.Cloth03, 0F);
        this.setLegacyPartOffsetZ(this.Cloth03, 0F);
        this.Cloth04.xRot = -0.052F;
        this.setLegacyPartOffsetY(this.Cloth04, 0F);
        this.setLegacyPartOffsetZ(this.Cloth04, 0F);
        // hair
        ...
        this.setLegacyPartOffsetX(this.EquipTBase, 0F);
        this.setLegacyPartOffsetY(this.EquipTBase, 0F);
    }
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        // 水上漂浮
        // 目視検証必須: 水面時の上下揺れが1.10.2相当の小振幅(0.025)で再現されること。
        // 目視未確認: 実機で水面待機時の高さ差と揺れ周期を比較すること。
        if (ent.getShipDepth(0) > 0D || ent.getShipDepth(1) > 0D) {
            this.translateLegacyPose(0F, angleX * 0.025F + 0.025F, 0F);
        ...
        this.setLegacyPartOffsetY(this.Cloth02, 0F);
        this.setLegacyPartOffsetZ(this.Cloth02, 0F);
        this.Cloth03.xRot = 0.087F;
        this.setLegacyPartOffsetY(this.Cloth03, 0F);
        this.setLegacyPartOffsetZ(this.Cloth03, 0F);
        this.Cloth04.xRot = -0.052F;
        ...
        this.setLegacyPartOffsetX(this.EquipTBase, -0.13F);
        this.setLegacyPartOffsetY(this.EquipTBase, 0F);
        ...
        if (ent.getIsSprinting() || f1 > 0.9F) {
            if (ent.getIsRiding()) {
                ...
                // [PORT] Restored from 1.10.2 GlStateManager.translate
                this.translateLegacyPose(0F, -0.06F, 0F);
            ...
            if (showTorpedo) {
                ...
                this.setLegacyPartOffsetX(this.EquipTBase, 0.17F);
                this.setLegacyPartOffsetY(this.EquipTBase, 0.64F);
        ...
        if (ent.getIsSneaking()) {
            ...
            this.translateLegacyPose(0F, 0.01F, 0F);
            ...
            this.setLegacyPartOffsetY(this.Cloth03, -0.2F);
            this.setLegacyPartOffsetZ(this.Cloth03, 0.03F);
        ...
        if (ent.getIsSitting() && !ent.getIsRiding()) {
            if (ent.getTickExisted() % 512 > 256) {
                ...
                // body
                // [PORT] Restored from 1.10.2 GlStateManager.translate
                this.translateLegacyPose(0F, -angleX * 0.05F - 0.1F, 0F);
                ...
                this.setLegacyPartOffsetY(this.Cloth03, -0.23F);
                this.Cloth04.xRot = -0.12F;
                this.setLegacyPartOffsetY(this.Cloth04, -0.16F);
                this.Ahoke01.xRot += 0.38F;
                ...
                if (ent.getStateEmotion(ID.S.Emotion) == ID.Emotion.BORED) {
                    ...
                    this.translateLegacyPose(0F, 0.26F, 0F);
                    ...
                    this.setLegacyPartOffsetY(this.Cloth03, -0.17F);
                    this.setLegacyPartOffsetZ(this.Cloth03, 0F);
                    this.Cloth04.xRot = 0.29F;
                    this.setLegacyPartOffsetY(this.Cloth04, -0.04F);
                    this.setLegacyPartOffsetZ(this.Cloth04, 0.02F);
                    this.Hair01.xRot -= 0.2F;
                    ...
                    this.setLegacyPartOffsetY(this.Cloth03, -0.05F);
            ...
            if (((net.minecraft.world.entity.Entity) ent)
                ...
                if (ent.getIsSitting()) {
                    if (((net.minecraft.world.entity.Entity) ent).getVehicle().isShiftKeyDown()) {
                        ...
                        this.translateLegacyPose(0F, 0.33F, 0.27F);

                    } else {
                        // [PORT] 1.10.2 -> 1.20.1: player mount sit translate.
                        this.translateLegacyPose(0F, 0.24F, 0.27F);
                    ...
                    this.setLegacyPartOffsetY(this.Cloth02, -0.11F);
                    this.Cloth03.xRot = -0.07F;
                    this.setLegacyPartOffsetY(this.Cloth03, -0.11F);
                    this.Cloth04.xRot = -0.11F;
                    this.setLegacyPartOffsetY(this.Cloth04, -0.08F);
                    // arm
                    ...
                    if (((net.minecraft.world.entity.Entity) ent).getVehicle().isShiftKeyDown()) {
                        ...
                        this.translateLegacyPose(0F, 0.16F, 0.17F);

                    } else {
                        // [PORT] 1.10.2 -> 1.20.1: player mount stand translate.
                        this.translateLegacyPose(0F, 0.07F, 0.17F);
            ...
            // normal mount
                ...
                if (ent.getIsSitting()) {
                    if (ent.getStateEmotion(ID.S.Emotion) == ID.Emotion.BORED) {
                        ...
                        this.setFaceDamaged(ent);
                        // body
                        this.translateLegacyPose(0F, -angleX * 0.05F - 0.16F, 0F);
                        this.Head.xRot *= 0.5F;
                        this.Head.yRot *= 0.75F;
                        this.Head.xRot += 0.5F;
                        this.BodyMain.xRot = 1.6F;
