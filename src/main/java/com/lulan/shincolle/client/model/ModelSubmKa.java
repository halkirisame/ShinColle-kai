...
public class ModelSubmKa extends ShipModelBaseAdv<Entity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(Reference.MOD_ID, "ss_ka"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition hairL01 = hair.addOrReplaceChild("HairL01",
                ...
                PartPose.offsetAndRotation(-4.9F, 8.0F, -7.2F, -0.17453292519943295F,
        ...
        PartDefinition hairR01 = hair.addOrReplaceChild("HairR01",
                ...
                PartPose.offsetAndRotation(5.9F, 7.7F, -7.5F, -0.17453292519943295F,
                        0.4363323129985824F, 0.13962634015954636F));

        hairR01.addOrReplaceChild("HairR02",
                CubeListBuilder.create().mirror().texOffs(24, 88)
                        .addBox(-1.0F, 0.0F, 0.0F, 2.0F, 12.0F, 5.0F),
                PartPose.offsetAndRotation(0.3F, 10.0F, 0.0F, 0.24434609527920614F,
                        0.08726646259971647F, -0.13962634015954636F));

        PartDefinition equipHead01 = head.addOrReplaceChild("EquipHead01",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-3.0F, -3.0F, 0.0F, 6.0F, 6.0F, 3.0F),
                PartPose.offsetAndRotation(0.0F, -1.0F, -8.0F, 0.2617993877991494F, 0.0F, 0.0F));

        PartDefinition equipHead03 = equipHead01.addOrReplaceChild("EquipHead03",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(0.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F),
                PartPose.offsetAndRotation(2.0F, 0.5F, -1.0F, 0.0F, -0.08726646259971647F, 0.0F));

        PartDefinition equipHead04 = equipHead03.addOrReplaceChild("EquipHead04",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 15.0F),
                PartPose.offsetAndRotation(7.0F, 0.0F, -1.0F, -0.17453292519943295F,
                        0.08726646259971647F, 0.0F));

        equipHead04.addOrReplaceChild("EquipHead05",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 9.0F, 2.0F),
                PartPose.offsetAndRotation(0.0F, -0.4F, 14.0F, 0.0F, 0.0F, 0.5918411493512771F));
        ...
        PartDefinition equipC01 = equipBase.addOrReplaceChild("EquipC01",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-6.0F, 0.0F, 0.0F, 12.0F, 10.0F, 4.0F),
                PartPose.offset(0.0F, -9.0F, 3.0F));

        PartDefinition equipC02 = equipC01.addOrReplaceChild("EquipC02",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-3.5F, -3.5F, 0.0F, 7.0F, 7.0F, 10.0F),
                PartPose.offsetAndRotation(0.0F, 5.0F, 3.0F, -0.08726646259971647F, 0.0F, 0.0F));

        equipC02.addOrReplaceChild("EquipC02b",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(0.0F, 0.0F, 0.0F, 9.0F, 3.0F, 3.0F),
                PartPose.offset(3.0F, -2.0F, 1.0F));

        equipC02.addOrReplaceChild("EquipC02a",
                CubeListBuilder.create().texOffs(0, 0)
        ...
        PartDefinition equipT01a = glowArmLeft02.addOrReplaceChild("EquipT01a",
                ...
                PartPose.offset(-6.5F, 6.5F, -1.0F));
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        this.setLegacyPartOffsetX(this.EquipT01a, 0F);
        this.setLegacyPartOffsetY(this.EquipT01a, 0F);
        this.setLegacyPartOffsetZ(this.EquipT01a, 0F);
        this.EquipC02.yRot = this.Head.yRot;
        this.EquipC02a.xRot = this.Head.xRot;
        ...
        if (ent.getIsSprinting() || f1 > 0.92F) { // 奔跑動作
            ...
            this.setLegacyPartOffsetX(this.EquipT01a, -0.08F);
        } // end is sprinting
        ...
        if (ent.getIsSitting() && !ent.getIsRiding()) { // 騎乘動作
            if (ent.getStateEmotion(ID.S.Emotion) == ID.Emotion.BORED) {
                // body
                // [PORT] Restored from 1.10.2 GlStateManager.translate
                this.translateLegacyPose(0F, angleX * 0.05F + 0.18F, 0F);
        ...
        if (ent.getAttackTick() > 41) {
            ...
            // equip
            this.setLegacyPartOffsetX(this.EquipT01a, 0.2F);
            this.setLegacyPartOffsetY(this.EquipT01a, 0.2F);
            this.setLegacyPartOffsetZ(this.EquipT01a, -0.5F);
        } // end attack
