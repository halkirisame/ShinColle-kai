...
/**
 * Light Cruiser Tenryuu hostile entity.
 * model state: 0:cannon, 1:head, 2:sword, 3:eye, 4:shoes
 */
public class EntityCLTenryuuMob extends BasicEntityShipHostile {
    ...
    public EntityCLTenryuuMob(EntityType<? extends EntityCLTenryuuMob> type, Level level) {
        super(type, level);
