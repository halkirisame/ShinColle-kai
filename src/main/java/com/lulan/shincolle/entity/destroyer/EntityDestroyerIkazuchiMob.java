...
public class EntityDestroyerIkazuchiMob extends BasicEntityShipHostile implements IShipRiderType {
    ...
    public EntityDestroyerIkazuchiMob(EntityType<? extends EntityDestroyerIkazuchiMob> type, Level level) {
        super(type, level);
        ...
        // model display
        this.setStateEmotion(ID.S.State, this.random.nextInt(4), false);
