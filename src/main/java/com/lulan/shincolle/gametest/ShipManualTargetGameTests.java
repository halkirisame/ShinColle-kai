...
public final class ShipManualTargetGameTests {
    ...
    public static void manualCommandHoldsFortySelectorPasses(GameTestHelper helper) {
        waitForFixtureChunks(helper, () -> verifyManualCommandHoldsFortySelectorPasses(helper));
    }
    ...
    public static void revengePreemptsManualWithoutErasingCommand(GameTestHelper helper) {
        waitForFixtureChunks(helper, () -> verifyRevengePreemptsManualWithoutErasingCommand(helper));
    }
    ...
    public static void manualResumesAfterRevengeEnds(GameTestHelper helper) {
        waitForFixtureChunks(helper, () -> verifyManualResumesAfterRevengeEnds(helper));
    }
    ...
    public static void repeatedPointerCommandTogglesManualOff(GameTestHelper helper) {
        waitForFixtureChunks(helper, () -> verifyRepeatedPointerCommandTogglesManualOff(helper));
    }
    ...
    public static void manualExpiresOnDeathButNeverFromElapsedTicks(GameTestHelper helper) {
        waitForFixtureChunks(helper, () -> verifyManualExpiresOnDeathButNeverFromElapsedTicks(helper));
    }
    ...
    public static void manualCommandHoldsTargetTheAutoSelectorRejects(GameTestHelper helper) {
        waitForFixtureChunks(helper, () -> verifyManualCommandHoldsTargetTheAutoSelectorRejects(helper));
    }
    ...
    private static void waitForFixtureChunks(GameTestHelper helper, Runnable verification) {
        Vec3 origin = fixtureOrigin(helper);
        Vec3 farthestEntityPosition = origin.add(4D, 0D, 0D);
        // Target selector passes can spatially scan immediately after the fixture is constructed.
