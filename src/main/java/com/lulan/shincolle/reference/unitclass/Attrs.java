...
public class Attrs {
    ...
    public static void checkAttrsLimit(float[] data) {
        ...
        if (data[ID.Attrs.HP] < 1F)
            data[ID.Attrs.HP] = 1F;
        if (data[ID.Attrs.ATK_L] < 1F)
            data[ID.Attrs.ATK_L] = 1F;
        if (data[ID.Attrs.ATK_H] < 1F)
            data[ID.Attrs.ATK_H] = 1F;
        if (data[ID.Attrs.ATK_AL] < 1F)
            data[ID.Attrs.ATK_AL] = 1F;
        if (data[ID.Attrs.ATK_AH] < 1F)
            data[ID.Attrs.ATK_AH] = 1F;
        if (data[ID.Attrs.HIT] < 1F)
            data[ID.Attrs.HIT] = 1F;
        if (data[ID.Attrs.SPD] < 0.2F)
            data[ID.Attrs.SPD] = 0.2F;
    }
    ...
    public float getAttackSpeed() {
        // prevent DBZ error
        if (this.AttrsBuffed[ID.Attrs.SPD] < 0.001F)
            return 0.001F;
